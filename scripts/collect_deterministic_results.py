...
for model_dir_name in MODEL_DIRS:
    ...
    for metrics_path in metric_files:
        try:
            ...
            # Track 1 常见: val / test
            # Track 2 常见: inner_val / outer_test
...
# Track 2: 按 model 聚合（10个heldout × 3 seeds）
